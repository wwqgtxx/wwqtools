package net.sf.wei.wwqtools.calculator.form;

import java.math.BigInteger;

import net.sf.wei.wwqtools.calculator.about.AboutShell;
import net.sf.wei.wwqtools.calculator.count.Count;
import net.sf.wei.wwqtools.pai.PaiShell;
...
public class MainForm { 
	 ...
	 */
	public void show() {
		shlCalculator.setImage(SWTResourceManager.getImage(MainForm.class, "/net/sf/wei/wwqtools/calculator/iocs/calc.PNG"));
